...
function update(dt, fireMode, shiftHeld)
  ...
  if fireMode == "alt" and availableOrbCount() == 6 and not status.resourceLocked("energy") and status.resourcePositive("shieldStamina") then
...
function setOrbPosition(spaceFactor, distance)
  for i = 1, 6 do
    ...
    animator.rotateTransformationGroup("orb"..i, 2 * math.pi * spaceFactor * ((i - 2) / 6))
  end
end
