...
function update(dt, fireMode, shiftHeld)
  ...
  if fireMode == "alt" and availableOrbCount() == 1 and not status.resourceLocked("energy") and status.resourcePositive("shieldStamina") then
  ...
  if self.shieldTransformTimer > 0 then
    ...
    setOrbPosition(1 - transformRatio * 1.0, transformRatio * 0.75)
    animator.resetTransformationGroup("orbs")
...
function activateShield()
  ...
  animator.setParticleEmitterActive("shieldtips1", 1)
  animator.setParticleEmitterActive("shieldtips2", 1)
  setStance("shield")
...
function deactivateShield()
  ...
  animator.stopAllSounds("shieldLoop")
  animator.setParticleEmitterActive("shieldtips1", false)
  animator.setParticleEmitterActive("shieldtips2", false)
  setStance("idle")
  activeItem.setItemShieldPolys()
  activeItem.setItemDamageSources()
  status.clearPersistentEffects("magnorbShield")
